...
ax2.set_ylabel("$MPKI$")
line2 = ax2.plot(mpki_Axis, label="Mean L2D_mpki", color="green",marker='o')
...
plt.title("[L2 (" + title + " cycle) - Geometric Mean IPC vs MPKI]")
lgd = plt.legend(lns, labs)
lgd.draw_frame(False)
print sys.argv[1]
print dir
outputIMGName = "../../report/graphs/L2/" + dir + "/mean.png"
